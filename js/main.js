...
//variables
var attrArray = ["1990","1995", "2000", "2005", "2010", "2015"]; //attributes
...
//chart bars scaled proportionally to fit frame
...
function setMap(){
    ...
    d3.queue()
        .defer(d3.csv, "./data/maternal.csv") //load attributes from csv
